...
impl core::fmt::Display for ParseError {
    fn fmt(&self, f: &mut core::fmt::Formatter<'_>) -> core::fmt::Result {
        match self {
            ...
            ParseError::Length { expected, got } => write!(f, "expected {expected} bytes, got {got}"),
...
impl From<hex::FromHexError> for ParseError {
    fn from(e: hex::FromHexError) -> Self { ParseError::Hex(e) }
}

impl From<core::num::ParseIntError> for ParseError {
    fn from(e: core::num::ParseIntError) -> Self { ParseError::Int(e) }
}
